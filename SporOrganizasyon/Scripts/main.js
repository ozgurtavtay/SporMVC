jQuery(document).ready(function($) {
    ...
    var u = $(".form-question.login").length;
    $(".flowbutton.login").on('click',function(){

		inputs[y] = input.eq(y).val();
        $(".form-question.login.visible").removeClass('visible');
        $(".form-question.login").eq(i).addClass('visible');
        $(".form-question.login:visible").find('.form-control.login').focus();
		i++;
		y++;
        console.log(inputs);
		if (i == u) {
            $('#flowbutton.login').removeClass('visible');
		}
    });

    $(".backbutton.login").on('click', function () {
	...
	var b = 0;
	var inputs = [];
	var input = $('.form-control.register');
    var c = $(".form-question.register").length;
    $(".flowbutton.register").on('click',function(){

		inputs[b] = input.eq(b).val();
        $(".form-question.register.visible").removeClass('visible');
        $(".form-question.register").eq(a).addClass('visible');
